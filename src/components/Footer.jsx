  ...
  return (
    <footer className="footer footer-center p-10 bg-base-200 text-base-content rounded mt-10 max-md:px-0">
      <nav className="grid grid-flow-col max-sm:grid-flow-row gap-4">
        <Link to="/" className="link link-hover text-2xl max-md:text-xl">
          Home
        </Link>
        <Link to="/shop" className="link link-hover text-2xl max-md:text-xl">
          Shop
        </Link>
        <Link to="/about" className="link link-hover text-2xl max-md:text-xl">
          About us
        </Link>
        <Link to="/contact" className="link link-hover text-2xl max-md:text-xl">
          Contact
        </Link>
        {!loginState && (
          <>
            <Link
              to="/login"
              className="link link-hover text-2xl max-md:text-xl"
            >
              Login
            </Link>
            <Link
      ...
      <aside>
        <p className="text-2xl max-sm:text-sm">
          Copyright © 2023 - All right reserved by Kuzma Clothing Shop
        </p>
      </aside>
    </footer>
  );
